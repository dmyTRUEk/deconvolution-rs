...
impl Load for SatExp_TwoDecExp {
    ...
    fn load_from_self_toml_value(toml_value: &TomlValue) -> Self {
        ...
        let initial_vads = InitialValues_SatExp_TwoDecExp::load_from_parent_toml_value(toml_value);
        SatExp_TwoDecExp {
            diff_function_type,
            initial_vads,
        }
...
impl InitialValuesVAD for InitialValues_SatExp_TwoDecExp<ValueAndDomain> {
    ...
    //     // let Self::F { amplitude, shift, tau_a, tau_b, tau_c } = Self::f_from_vec_v(params);
